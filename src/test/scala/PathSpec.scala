...
class PathSpec extends FlatSpec with Matchers {
  ...
  "a path helper" should "find trivial path" in {
    ...
    path shouldBe Some(Seq(Segment(pa, pb)))
  }
  ...
  it should "find a path from several segments" in {
    ...
    path shouldBe Some(Seq(Segment(pa, pb), Segment(pb, pc), Segment(pc, pd)))
  }
  ...
  it should "find the shortest path" in {
    ...
    path shouldBe Some(Seq(Segment(pa, pc), Segment(pc, pd)))
  }
